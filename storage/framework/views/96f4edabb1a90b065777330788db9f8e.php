...
<head>
  ...
  <script src="<?php echo e(asset('vendor/vega/vega.min.js')); ?>"></script>
  <script src="<?php echo e(asset('vendor/vega/vega-lite.min.js')); ?>"></script>
  <script src="<?php echo e(asset('vendor/vega/vega-embed.min.js')); ?>"></script>
  <style>
    /* Global Styles */
    :root {
      /* Color Palette */
...
<body>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const apex_stats_1 = <?php echo json_encode($apexStats1, 15, 512) ?>;
      const apex_stats_2 = <?php echo json_encode($apexStats2, 15, 512) ?>;
...
<?php /**PATH D:\laravel-projects\apex-legends-tracker-2\resources\views/dashboard.blade.php ENDPATH**/ ?>