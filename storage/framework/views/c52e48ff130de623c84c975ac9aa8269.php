...
<?php $__env->startSection('title', 'AI Chatbot - Apex Legends Statistics'); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Fetch main stats
        fetch('<?php echo e(asset("data/apex_stats_1.json")); ?>')
            .then(response => {
                if (!response.ok) {
        ...
        fetch('<?php echo e(asset("data/apex_stats_1_day.json")); ?>')
            .then(response => {
                if (!response.ok) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel-projects\apex-legends-tracker-2\resources\views/chatbot.blade.php ENDPATH**/ ?>